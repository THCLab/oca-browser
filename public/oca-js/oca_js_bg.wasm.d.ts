...
export const addAttributeToBundle: (
  a: any,
  b: number,
  c: number,
  d: number,
...
export const addOverlayToBundle: (
  a: any,
  b: number,
  c: number,
  d: number,
...
export const createBundleWithAttributes: (
  a: number,
  b: number,
  c: any
) => [number, number, number]
export const generateOCAfile: (
  a: number,
  b: number,
  c: number,
  d: number
...
export const getBundleClassification: (
  a: any
) => [number, number, number, number]
...
export const parseOCAfile: (
  a: number,
  b: number,
  c: number,
  d: number
) => [number, number, number]
export const removeAttributeFromBundle: (
  a: any,
  b: number,
  c: number
) => [number, number, number]
export const removeOverlayFromBundle: (
  a: any,
  b: number,
  c: number
) => [number, number, number]
