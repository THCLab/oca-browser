...
export function addAttributeToBundle(oca_bundle: any, attribute_name: string, attribute_type: string): any;

export function addOverlayToBundle(oca_bundle: any, overlay_name: string, overlay_type: string, overlay_properties: any): any;
...
export function removeAttributeFromBundle(oca_bundle: any, attribute_name: string): any;

export function removeOverlayFromBundle(oca_bundle: any, overlay_name: string): any;
...
export interface InitOutput {
    ...
    readonly addAttributeToBundle: (a: any, b: number, c: number, d: number, e: number) => [number, number, number];
    readonly addOverlayToBundle: (a: any, b: number, c: number, d: number, e: number, f: any) => [number, number, number];
    ...
    readonly init: () => void;
    readonly loadBundle: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly parseOCAfile: (a: number, b: number, c: number, d: number) => [number, number, number];
    readonly removeAttributeFromBundle: (a: any, b: number, c: number) => [number, number, number];
    readonly removeOverlayFromBundle: (a: any, b: number, c: number) => [number, number, number];
