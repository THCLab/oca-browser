 ...
 * @returns {any}
 */
export function addAttributeToBundle(oca_bundle, attribute_name, attribute_type) {
    const ptr0 = passStringToWasm0(attribute_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(attribute_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {any}
 */
export function addOverlayToBundle(oca_bundle, overlay_name, overlay_type, overlay_properties) {
    const ptr0 = passStringToWasm0(overlay_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(overlay_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.addOverlayToBundle(oca_bundle, ptr0, len0, ptr1, len1, overlay_properties);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
export function buildFromOCAfile(ocafile_str, overlay_file) {
    const ptr0 = passStringToWasm0(ocafile_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
export function createBundleWithAttributes(classification, attributes) {
    const ptr0 = passStringToWasm0(classification, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
